...
function hitup_Libraries() {
  if (updateJSON.identity.team.match(/SE/i)
    && updateJSON.identity.sheetNames.normal.match(/Non Full Process/i)) {
    SREE_Chrono.getAccounts(SpreadsheetApp.openById("15svGQMYJeh9UyRdEHLCbKqf2wgQ-ksLGiKLTPSqJ3Hg"));
    return;
    ...
    EE_Chrono.getAccounts(SpreadsheetApp.openById("15yRzSrRuom5Rtg3aSdhHq6iYKy4dceP71f7bTYHAfmg"));
    return;
